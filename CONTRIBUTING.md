...
This outlines how to propose a change to animovement. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("roaldarbol/animovement", fork = TRUE)`.
...
Please note that the animovement project is released with a [Contributor
Code of Conduct](http://animovement.dev/animovement/CODE_OF_CONDUCT.md).
