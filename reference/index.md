...
These functions allow you to manage your animovement packages.
...
- [`animovement_install_suggested()`](http://animovement.dev/animovement/reference/animovement_install_suggested.md)
  [`animovement_show_suggested()`](http://animovement.dev/animovement/reference/animovement_install_suggested.md)
