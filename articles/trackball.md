...
```
    ...
    [1] "/tmp/RtmptCWmxg/trackball_beetles/named_cols_opticalflow_sensor_1.csv"
    [2] "/tmp/RtmptCWmxg/trackball_beetles/named_cols_opticalflow_sensor_2.csv"
...
```
    ...
    filename          (character) : "/tmp/RtmptCWmxg/trackball_beetles/named_cols_opticalflow_sensor_1.csv, /tmp/RtmptCWmxg/trackball_beetles/named_cols_opticalflow_sensor_2.csv"
