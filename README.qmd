...
* [`aniframe`](https://animovement.dev/aniframe) provides the core data structures that the rest of the ecosystem is built on — the shared representation that lets these packages hand data to one another.
