...
`animovement` is part of the [animovement](https://animovement.dev) suite — the meta-package that installs, attaches and keeps the suite in sync.

## Where to look things up

- **This package's API** — <https://animovement.dev/animovement/llms.txt> lists every exported
...
- **Write the pull request title as a [Conventional Commit](https://www.conventionalcommits.org/en/v1.0.0/)**
  — `fix(animovement): keep metadata through filter_kalman()`. Merges squash, so the title becomes the
