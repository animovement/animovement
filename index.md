...
package bundles them, so a single
[`library(animovement)`](https://animovement.dev) gives you the whole
workflow with versions and conflicts sorted out for you.
...
explicit to anyone who opens it, and keeps
[`library(animovement)`](https://animovement.dev) meaning the same thing
for all of them.
